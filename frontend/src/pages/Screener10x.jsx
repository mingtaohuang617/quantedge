  ...
  return (
    <div className={`glass-card p-2 border transition group ${
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-1.5">
            ...
            {item.bottleneck_layer === 2 && (
              <span className="text-[9px] px-1 py-px rounded bg-violet-500/15 text-violet-200 border border-violet-500/40">L2</span>
            )}
            {item.bottleneck_layer === 1 && (
              <span className="text-[9px] px-1 py-px rounded bg-blue-500/15 text-blue-200 border border-blue-500/40">L1</span>
            )}
      ...
      <div className="flex items-center gap-0.5 mb-1">
        ...
        <span className="text-[9px] text-[#7a8497] ml-1">卡位</span>
      </div>
