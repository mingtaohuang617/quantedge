...
export const STOCK_CN_NAMES = {
  ...
  BABA: "阿里巴巴", KDP: "胡椒博士", CSX: "CSX运输", NDAQ: "纳斯达克交易所",
  AXON: "Axon", FICO: "费埃哲", MSI: "摩托罗拉解决方案", ROL: "罗林斯",
  // ── ETF ──
...
export const STOCK_CN_DESCS = {
  ...
  // ── 美股补充 ──
  BABA: "中国最大的电商和云计算平台，运营天猫、淘宝和阿里云，业务覆盖电商、金融科技、物流和数字娱乐。",
  KDP: "美国领先的饮料公司，旗下拥有 Keurig 咖啡机系统、胡椒博士、七喜和绿山咖啡等品牌。",
  CSX: "美国东部领先的铁路货运公司，运营覆盖 23 个州的铁路网络。",
  NDAQ: "运营纳斯达克证券交易所，同时提供市场数据、指数和金融科技服务。",
  AXON: "执法和军用装备公司，旗下 Taser 电击枪和随身记录仪是全球执法标配。",
  FICO: "全球领先的分析软件公司，FICO 信用评分是美国个人信用的行业标准。",
  MSI: "全球领先的公共安全和企业通信解决方案提供商，产品包括对讲机、视频监控和指挥调度系统。",
  ROL: "全球领先的虫害防治服务公司，旗下 Orkin 是北美最大的虫害控制品牌。",
};

// 英文公司描述（与 STOCK_CN_DESCS 一一对应；英文模式优先用，避免退化成纯公司名）
// 由 zh 描述经 DeepSeek 批量翻译 + 人工校验生成。
export const STOCK_EN_DESCS = {
  NVDA: "Global leading GPU and AI chip designer, products widely used in data centers, gaming, autonomous driving, and AI training/inference.",
  AMD: "Designs and sells high-performance CPUs, GPUs, and data center accelerators; major competitor to Intel and Nvidia.",
  AVGO: "Global leader in semiconductors and infrastructure software, covering networking, storage, wireless communications, and enterprise software.",
  QCOM: "Mobile communication chip giant, designs Snapdragon processors and has extensive wireless communication patent licensing business.",
  TXN: "One of the world's largest analog chip manufacturers, products widely used in industrial, automotive, and consumer electronics.",
  AMAT: "One of the world's largest semiconductor equipment manufacturers, providing film deposition, etching, and inspection equipment for chip manufacturing.",
  LRCX: "Semiconductor equipment company focusing on etching and deposition equipment for wafer processing, serving advanced process chip manufacturing.",
  KLAC: "Provider of semiconductor equipment and yield management solutions, specializing in wafer inspection and metrology equipment.",
  MRVL: "Designs semiconductor solutions for data centers, enterprise networking, and carrier infrastructure.",
  NXPI: "Leader in automotive and IoT semiconductors, products used in in-vehicle systems, secure payments, and smart connectivity.",
  ADI: "Designs high-performance analog, mixed-signal, and digital signal processing chips serving industrial and automotive markets.",
  MCHP: "Designs and manufactures microcontrollers, analog chips, and flash memory products widely used in embedded control systems.",
  ON: "Supplier of power semiconductors and sensor chips, focusing on automotive electrification and new energy applications.",
  GFS: "World's third-largest pure-play foundry, providing mature process chip manufacturing services, headquartered in the US.",
  MU: "Global leader in memory chip manufacturing, producing DRAM and NAND flash, serving data centers and mobile devices.",
  ASML: "World's only EUV lithography machine manufacturer, holding the most advanced core equipment technology for semiconductor manufacturing.",
  SNPS: "EDA (Electronic Design Automation) software leader, providing simulation, verification, and IP core tools for chip design.",
  CDNS: "Supplier of EDA software and IP cores, helping engineers design and verify complex integrated circuits and systems.",
  ARM: "World's most widely used chip architecture design company, its instruction set used in the vast majority of smartphone processors.",
  SMCI: "Provider of high-performance server and storage solutions, focused on AI and data center infrastructure.",
  DRAM: "Exchange-traded fund tracking the performance of the Asian semiconductor and memory chip industry.",
  SNDK: "SanDisk — global leader in NAND flash storage, covering SSDs, memory cards, USB drives and other consumer and enterprise storage; spun off from Western Digital as an independent public company.",
  MSFT: "World's largest software company, with core products including Windows, Office, Azure cloud computing, and AI assistant Copilot.",
  ADBE: "Creative and document software giant, with industry-standard tools such as Photoshop, Illustrator, and Acrobat.",
  INTU: "Financial software company, with TurboTax, QuickBooks, and Mailchimp serving small businesses and individual users.",
  CRM: "World's largest CRM (Customer Relationship Management) cloud platform, helping businesses manage sales, service, and marketing processes.",
  PANW: "Global leading cybersecurity company, providing firewalls, cloud security, and AI-driven threat detection solutions.",
  CRWD: "Cloud-native endpoint security platform, using AI technology for real-time threat detection and response.",
  ZS: "Cloud security company, providing a zero-trust network access platform to securely connect users and applications.",
  FTNT: "Cybersecurity company, renowned for FortiGate firewalls and Security Fabric architecture, serving global enterprise customers.",
  WDAY: "Enterprise cloud platform for human resources and financial management, helping large enterprises manage HR and finance processes.",
  TEAM: "Collaboration software company, with Jira and Confluence as core tools for software development teams.",
  DDOG: "Cloud monitoring and security analytics platform, helping enterprises monitor application performance, logs, and infrastructure in real time.",
  MDB: "NoSQL database company, MongoDB is one of the world's most popular document databases.",
  SPLK: "Machine data analytics and security information platform, helping enterprises gain operational insights from log and event data.",
  ROP: "Industrial technology group, building a diversified portfolio of vertical software and technology products through an acquisition strategy.",
  ADP: "World's largest payroll and HR outsourcing service provider, offering payroll and personnel management solutions for businesses.",
  PAYX: "Payroll processing and human resources service company, primarily serving small and medium-sized enterprise customers.",
  VRSK: "Data analytics and risk assessment company, providing decision support tools for insurance, finance, and energy industries.",
  ANSS: "Engineering simulation software company, products used for virtual testing in aerospace, automotive, and electronics.",
  CPRT: "World's largest online vehicle auction platform, specializing in accident and insurance-recovered vehicles.",
  PLTR: "Big data analytics and AI platform company, providing data integration and intelligent decision solutions for governments and enterprises.",
  MSTR: "Enterprise analytics software company, also one of the publicly traded companies holding the largest amount of Bitcoin globally.",
  GOOGL: "World's largest search engine and online advertising company, with Google Search, YouTube, Android, and cloud computing businesses.",
  GOOG: "Alphabet Class C stock, same company as GOOGL (Google's parent) but without voting rights.",
  META: "World's largest social media company, owning Facebook, Instagram, WhatsApp, and the metaverse platform.",
  AMZN: "World's largest e-commerce platform and cloud computing service provider; AWS is the leading global cloud infrastructure platform.",
  NFLX: "World's largest streaming platform, offering subscription services for original and licensed movies and TV series.",
  BKNG: "World's largest online travel booking platform, owning brands like Booking.com and Priceline.",
  ABNB: "World's largest short-term rental platform, connecting hosts and travelers across more than 220 countries and regions.",
  MELI: "Largest e-commerce and fintech platform in Latin America, covering major markets such as Brazil, Argentina, and Mexico.",
  PYPL: "Global leading digital payment platform, providing online payments, money transfers, and merchant payment services.",
  DASH: "Leading local on-demand delivery platform in the US, offering food delivery and everyday essentials delivery services.",
  TTD: "Programmatic advertising technology platform, helping advertisers place digital ads across multiple channels with AI precision.",
  COIN: "Largest compliant cryptocurrency trading platform in the US, offering trading services for Bitcoin, Ethereum, and other digital assets.",
  RDDT: "World's largest community forum platform, where users share content and discuss in various topic boards.",
  HOOD: "Commission-free stock and cryptocurrency trading platform, known for its simplified mobile experience.",
  APP: "Mobile advertising and app monetization platform, using AI technology to help app developers acquire users and increase revenue.",
  AAPL: "World's largest technology company by market cap, designing and selling iPhone, Mac, iPad, and other consumer electronics and services ecosystem.",
  TSLA: "Global leader in electric vehicles and clean energy, also involved in autonomous driving, energy storage, and AI robotics.",
  TMUS: "Second-largest wireless carrier in the US, known for 5G network coverage and price competitiveness.",
  CSCO: "World's largest networking equipment manufacturer, providing routers, switches, and cybersecurity products.",
  ISRG: "Leader in surgical robotics, its da Vinci system widely used in minimally invasive surgery with the largest global installed base.",
  AMGN: "One of the world's largest biotechnology companies, focused on innovative drugs in oncology, cardiovascular, and orthopedics.",
  GILD: "Biopharmaceutical company, leading in antiviral drugs with globally leading treatments for hepatitis B and HIV.",
  VRTX: "Biopharmaceutical company focused on rare diseases such as cystic fibrosis, with a monopoly drug portfolio in that area.",
  REGN: "Biopharmaceutical company known for antibody drug technology platforms, covering ophthalmology and immunology indications.",
  BIIB: "Biotechnology company specializing in neuroscience, developing drugs for Alzheimer's disease and multiple sclerosis.",
  ILMN: "Global leader in gene sequencing instruments and reagents, its platform generates approximately 80% of the world's genomic data.",
  DXCM: "Manufacturer of continuous glucose monitoring devices, helping diabetic patients track blood sugar levels in real time.",
  IDXX: "Global leader in pet diagnostic testing equipment and services, covering veterinary clinics and laboratories.",
  AZN: "Global leading pharmaceutical company focused on innovative drug R&D in oncology, cardiovascular, and respiratory areas.",
  GEHC: "Medical technology company from General Electric, providing medical imaging, ultrasound, and patient monitoring equipment.",
  COST: "World's largest membership warehouse club, known for low-priced bulk products and high membership renewal rates.",
  SBUX: "World's largest chain coffee brand, operating over 35,000 stores globally.",
  MAR: "World's largest hotel group, owning more than 30 hotel brands including Marriott, Sheraton, and The Ritz-Carlton.",
  ORLY: "Leading automotive parts retailer in the US, focusing on the aftermarket maintenance parts market.",
  ROST: "US discount apparel retail chain, selling branded clothing at prices below department stores.",
  LULU: "Premium athletic and lifestyle apparel brand, known for yoga pants and positioned as an active lifestyle brand.",
  DLTR: "US discount retail chain, serving price-sensitive consumers with low-priced everyday and household items.",
  PEP: "World's second-largest food and beverage company, owning brands such as Pepsi, Lay's, and Quaker.",
  MDLZ: "Global snack giant, owning well-known brands like Oreo, Cadbury, and Milka.",
  KHC: "North American food giant, owning brands like Heinz Ketchup, Kraft Cheese, and Oscar Mayer.",
  MNST: "Energy drink company, Monster Energy is one of the world's best-selling functional drinks.",
  WMT: "World's largest retailer, operating over 10,000 physical stores and e-commerce platforms in the US and globally.",
  CTAS: "Provider of corporate uniforms and workplace services, offering uniform rental and cleaning services to various industries.",
  FAST: "Distributor of industrial fasteners and safety supplies, serving manufacturing customers through vending machines and store networks.",
  PCAR: "Truck manufacturer, with Peterbilt and Kenworth being leading heavy-duty truck brands in North America.",
  ODFL: "Leading less-than-truckload (LTL) freight company in the US, known for high service quality and operational efficiency.",
  CTSH: "Global IT services and consulting company, providing digital transformation, cloud computing, and software development services.",
  CDW: "Leading IT solutions distributor in the US, providing hardware, software, and services to enterprise and government customers.",
  CEG: "Largest carbon-free energy producer in the US, operating the largest fleet of nuclear power plants in the country.",
  FANG: "Leading oil and gas exploration and production company in the Permian Basin, known for high efficiency and low cost.",
  BKR: "Global leader in oilfield services and equipment, providing drilling and technical services to the oil and gas industry.",
  AEP: "Large US electric utility company, providing electricity to over 5 million customers across 11 states.",
  XEL: "Leading clean energy utility company in the US, heavily investing in wind and solar power generation.",
  EXC: "One of the largest utility holding companies in the US, operating power generation and distribution businesses.",
  CCEP: "Coca-Cola's bottling and distribution partner in Western Europe, covering markets such as the UK, France, and Germany.",
  SIRI: "North American satellite radio and audio streaming company, providing subscription content for music, sports, and news.",
  EA: "Global leading video game publisher, owning popular franchises such as FIFA/EA Sports FC and Apex Legends.",
  WBD: "Global entertainment media company, owning content brands and streaming platforms including HBO, CNN, and Discovery.",
  LIN: "World's largest industrial gas company, supplying oxygen, nitrogen, and other industrial gases to manufacturing, medical, and electronics industries.",
  RKLB: "Commercial space company, developing and operating the Electron small launch vehicle, providing satellite launch and space system services.",
  LITE: "Optical communications component manufacturer, providing lasers and optical transceivers for data centers and telecom networks.",
  AAOI: "Optical communications technology company, designing and manufacturing high-speed optical transceivers for data center interconnects.",
  QQQ: "ETF tracking the Nasdaq-100 Index, covering the 100 largest non-financial technology companies in the US.",
  SPY: "ETF tracking the S&P 500 Index, the world's largest and most liquid stock fund.",
  IWM: "ETF tracking the Russell 2000 small-cap index, reflecting the overall performance of US small-cap companies.",
  IGV: "ETF tracking the North American software industry, holding software leaders such as Microsoft, Adobe, and CRM.",
  SMH: "ETF tracking the semiconductor industry, covering global chip giants including Nvidia, TSMC, and ASML.",
  MARS: "Actively managed space-themed ETF, investing in space exploration, satellite, and space technology companies.",
  UFO: "ETF tracking global space and space economy companies.",
  EWY: "ETF tracking the South Korean stock market, mainly holding Samsung Electronics, SK Hynix, and other Korean blue chips.",
  IYZ: "ETF tracking the US telecommunications industry, covering telecom operators and communications equipment companies.",
  TQQQ: "3x leveraged ETF on the Nasdaq-100 Index, suitable for short-term trading with extreme volatility.",
  ARKK: "Actively managed innovation-themed ETF by Ark Invest, focusing on disruptive technology and biotechnology companies.",
  CWEB: "2x leveraged ETF tracking Chinese internet companies, holding Tencent, Alibaba, Meituan, etc.",
  YINN: "3x leveraged ETF on Chinese large-cap stocks, tracking the daily performance of the FTSE China 50 Index.",
  UGL: "2x leveraged ETF on gold prices, tracking twice the daily return of gold spot price.",
  SCO: "2x inverse ETF on crude oil prices, suitable for bearish views on crude oil.",
  KORU: "3x leveraged ETF on the South Korean stock market, tracking the daily performance of the MSCI Korea Index.",
  BABX: "2x leveraged ETF on Alibaba (BABA), amplifying two times the daily return of Alibaba's stock price, highly volatile, suitable for short-term directional trading.",
  SOXL: "3x leveraged ETF on the semiconductor industry, extremely volatile, suitable for short-term directional trading.",
  SOXS: "3x inverse ETF on the semiconductor industry, suitable when bearish on the semiconductor sector.",
  RKLX: "Rocket Lab (RKLB) daily 2x leveraged ETF, tracking twice the daily performance of RKLB's stock price.",
  SNXX: "SanDisk (SNDK) daily 2x leveraged ETF, tracking twice the daily performance of SNDK's stock price.",
  "00005.HK": "HSBC Holdings is one of the world's largest banking and financial services organizations, headquartered in London, with operations in over 60 countries.",
  "00700.HK": "One of China's largest internet companies, owning WeChat and QQ social platforms, along with gaming, cloud computing, and fintech businesses.",
  "09988.HK": "China's largest e-commerce platform, owning Taobao, Tmall, and Alibaba International, also operating Alibaba Cloud and Ant Group.",
  "01276.HK": "Leading innovative drug company in China, focusing on drug R&D and sales in oncology, anesthesia, and autoimmune diseases.",
  "03486.HK": "ETF tracking the Asian Semiconductor Select Index, covering chip companies from mainland China, South Korea, and Taiwan.",
  "07552.HK": "Hang Seng Tech Index daily inverse (-2x) product, suitable when bearish on Hong Kong tech stocks.",
  "07747.HK": "Samsung Electronics daily 2x leveraged product, tracking twice the daily performance of Samsung Electronics' stock.",
  "03986.HK": "China's leading storage chip and microcontroller design company, covering NOR Flash and 32-bit MCU products.",
  "07234.HK": "ChiNext Index daily 2x leveraged product, suitable when bullish on China's sci-tech innovation board.",
  "07200.HK": "Hang Seng Index daily 2x leveraged product, suitable when bullish on Hong Kong blue chips.",
  "07299.HK": "Gold futures daily 2x leveraged product, tracking twice the daily performance of London gold price.",
  "07709.HK": "SK Hynix daily 2x leveraged product, tracking the stock performance of South Korean memory chip giant SK Hynix.",
  "03690.HK": "China's largest local life services platform, providing food delivery, dine-in, travel, and community group buying services.",
  "09999.HK": "Leading internet technology company in China, core businesses include online gaming, music, and online education.",
  "09618.HK": "China's second-largest e-commerce platform, known for its self-operated model and logistics network, also expanding into instant retail.",
  "01024.HK": "Leading short video social platform in China, Kuaishou App has over 600 million monthly active users.",
  "09888.HK": "China's largest search engine company, also heavily investing in AI large models and autonomous driving technology.",
  "00981.HK": "Mainland China's most advanced wafer foundry, providing chip manufacturing services at 14nm and above processes.",
  "09626.HK": "Leading youth culture community and video platform in China, known for danmaku interaction and ACG content.",
  "01810.HK": "China's consumer electronics and smart home ecosystem leader, covering smartphones, IoT devices, and internet services.",
  "02382.HK": "Global leading optical lens and optoelectronic product manufacturer, widely used in smartphone cameras and automotive optics.",
  "09961.HK": "China's largest online travel platform, providing hotel booking, flight tickets, and travel packages.",
  "01347.HK": "China's second-largest wafer foundry, specializing in power devices and embedded memory among other specialty processes.",
  "02015.HK": "Leading new energy vehicle company in China, primarily offering extended-range electric SUVs and pure electric models.",
  "09868.HK": "Chinese new energy vehicle company, focusing on R&D, manufacturing, and sales of smart electric vehicles.",
  "06690.HK": "China's home appliance industry leader, owning brands such as Haier, Casarte, and GE Appliances.",
  "01211.HK": "World's largest new energy vehicle manufacturer, also a leading company in power batteries and photovoltaics.",
  "02269.HK": "Global leading biologics CDMO, providing contract R&D and manufacturing services for biopharmaceuticals.",
  "00268.HK": "Leading enterprise management cloud service provider in China, offering ERP, financial, and HR SaaS products.",
  "00241.HK": "Alibaba's healthcare platform, providing online pharmaceutical retail and internet medical services.",
  "00941.HK": "China's largest telecom operator, with the most mobile subscribers globally, also operating cloud computing and data center businesses.",
  "01299.HK": "Largest independent listed life insurance group in Asia-Pacific, operating in 18 markets.",
  "00388.HK": "Hong Kong Exchanges and Clearing Limited, operating Hong Kong's stock, futures, and commodity trading markets.",
  "02318.HK": "One of China's largest comprehensive financial services groups, covering insurance, banking, investment, and technology.",
  "00939.HK": "One of China's four largest state-owned commercial banks, with globally leading asset scale and nationwide branches.",
  "01398.HK": "The world's largest commercial bank by assets, the top among China's four state-owned banks.",
  "03988.HK": "One of China's four state-owned banks, also the most internationalized Chinese commercial bank.",
  "03968.HK": "Leading retail bank in China, known for fintech and wealth management capabilities, dubbed the 'Retail King'.",
  "00883.HK": "China's largest offshore oil and gas producer, conducting exploration and development in multiple global sea areas.",
  "02628.HK": "China's largest life insurance company, with an extensive sales network and customer base.",
  "00027.HK": "Leading gaming and entertainment resort operator in Macau, owning properties such as Galaxy Macau.",
  "02020.HK": "Leading sportswear group in China, owning multiple sports brands including Anta, FILA, and Arc'teryx.",
  "00175.HK": "Leading private automobile manufacturer in China, covering fuel vehicles and new energy vehicles, owning the Zeekr brand.",
  "00066.HK": "MTR Corporation, operating Hong Kong's metro and light rail systems, also running railways in multiple cities globally.",
  "09633.HK": "China's largest bottled water and beverage company, with Nongfu Spring and Oriental Leaf as well-known brands.",
  "00016.HK": "One of Hong Kong's largest property developers, with businesses in residential, commercial, and hotels.",
  "02388.HK": "Wholly owned subsidiary of Bank of China in Hong Kong, one of Hong Kong's major note-issuing banks and commercial banks.",
  BABA: "China's largest e-commerce and cloud computing platform, operating Tmall, Taobao, and Alibaba Cloud, covering e-commerce, fintech, logistics, and digital entertainment.",
  KDP: "Leading US beverage company, owning brands such as Keurig coffee brewing system, Dr Pepper, 7UP, and Green Mountain Coffee.",
  CSX: "Leading railroad freight company in the eastern US, operating a rail network covering 23 states.",
  NDAQ: "Operates the Nasdaq Stock Exchange, also providing market data, indices, and fintech services.",
  AXON: "Law enforcement and military equipment company, with Taser stun guns and body cameras as global law enforcement standards.",
  FICO: "Global leading analytics software company, FICO credit score is the industry standard for US personal credit.",
  MSI: "Global leading provider of public safety and enterprise communication solutions, including two-way radios, video surveillance, and dispatch systems.",
